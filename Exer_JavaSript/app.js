...
function CustoCarro() {
    let custoF = parseFloat(document.getElementById('custoFabrica').value);
    let percentualD = parseFloat(document.getElementById('percDistribuidor').value);
    let percentualI = parseFloat(document.getElementById('percImpostos').value);

    let valorTotal = custoF + (custoF * percentualD) + (custoF * percentualI);
